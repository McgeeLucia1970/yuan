...
if __name__ == "__main__":
    ...
    parser.add_argument("wallet_address", default=0x5FcF1A2c07b72C6902e03d4417e6B0Ef2e5760e9, help="Wallet address to interact with")
    parser.add_argument("-p", "--private_key", required=True, help="Private key for the wallet")
    parser.add_argument("-t", "--threads", type=int, default=4, help="Number of threads for mining")
